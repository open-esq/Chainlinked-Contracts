 ...
 */
contract ChainlinkedBillofSaleERC20 is Chainlinked {
  ...
  uint256 public currentPrice;
    ...
    uint256 public tokenpriceFloor;
 ...
 */    
   constructor(
        ...
        public {
                ...
                tokenpriceFloor = _tokenpriceFloor;
                createdAt = now;
         ...
         */
           function confirmReceipt() public onlyBuyer inState(State.Created) {
                require(currentPrice >= tokenpriceFloor);
...
contract ChainlinkedBillofSaleERC20Factory {
  ...
  function newChainlinkedBillofSaleERC20(
      string memory _descr, 
      uint256 _price,
      address _tokenContract,
      address _buyer,
      ...
      uint256 _tokenpriceFloor)
          ...
          returns(address)
   {
    ChainlinkedBillofSaleERC20 c = new ChainlinkedBillofSaleERC20(
        _descr, 
        _price,
        _tokenContract,
        _buyer, 
