...
/**
 * @dev ERC20 Token Escrow legible as Bill of Sale with Arbitration logic and Chainlink to Gold Price (DGX).
 * @author R. Ross Campbell
 */
contract GoldLINKBillofSale is Chainlinked {
  ...
  uint256 public currentGoldPrice;
    ...
    address public tokenContract = 0x7Ae416e720e981510bA23A8EBD0f1074Ac78E502;
    address public buyer;
    address public seller;
    address public arbiter;
    uint256 public createdAt;
    uint256 public goldPriceFloor;
...
/**
 * @dev Sets the BOS transaction values for `descr`, `price`, `buyer`, `seller`, 'arbiter', 'arbiterFee', 'goldPriceFloor'. All seven of
 ...
 */    
   constructor(
        ...
        public {
                ...
                goldPriceFloor = _goldPriceFloor;
                createdAt = now;
         ...
         */
           function confirmReceipt() public onlyBuyer inState(State.Created) {
                require(currentGoldPrice >= goldPriceFloor);
         ...
         */
           function resolveDispute(uint256 buyerAward, uint256 sellerAward) public onlyArbiter inState(State.Disputed) {
            ...
            function requestGoldPrice() public onlyBuyer {
                    // newRequest takes a JobID, a callback address, and callback function as input
                    Chainlink.Request memory req = newRequest(UINT256_MUL_JOB, this, this.fulfill.selector);
                    // Adds a URL with the key "get" to the request parameters
                    req.add("get", "https://min-api.cryptocompare.com/data/price?fsym=DGX&tsyms=USD");
...
contract GoldLINKBillofSaleFactory {
  ...
  function newGoldLINKBillofSale(
      string memory _descr, 
      uint256 _price,
      address _buyer,
      address _seller, 
      ...
      uint256 _goldPriceFloor)
          ...
          returns(address)
   {
    GoldLINKBillofSale c = new GoldLINKBillofSale(
        _descr, 
        _price,
        _buyer, 
        _seller,
