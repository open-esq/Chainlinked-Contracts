...
contract Etherchecker is Chainlinked {
...
contract EthercheckerFactory {
    ...
    function newEtherchecker()
        public
        returns(address newContract)
    {
        Etherchecker c = new Etherchecker();
        contracts.push(c);
    ...
    function seeEtherchecker(uint pos)
        public
        constant
